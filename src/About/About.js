        ...
        >
          <div className="carousel">
            ...
            <div className="carousel-note">
              <h3>Welcome to MARV Company!</h3>
              <p>
                At Marv, we create spaces that blend beauty with functionality.
                Our team is dedicated to delivering stunning, innovative, and
        ...
        <div className="services-section">
          ...
          <div className="services-list">
            <div className="service-item">
              <h4>Interior Design</h4>
              <p>
                We offer personalized interior design solutions that bring your
                vision to life.
              </p>
            </div>
            <div className="service-item">
            ...
            <div className="service-item">
              <h4>Consultation</h4>
              <p>
                Expert advice on how to optimize your space, color schemes, and
                more.
              </p>
            </div>
          </div>
